...
//             アカウントが存在するか　　　　　　
              String state = "select name, password from profiles where name =? and password =?";
              ...
              try{
                 ...
                 db_st.setString(2,p);
                  ...
                  while(db_data.next()){
                      ...
                      String pass = db_data.getString("password");
 
                      a = 1;
                      
                      out.println("こんにちは"+name+"さん");
                      out.println("<a href=./toroku.jsp>商品情報登録</a>");
                      out.println("<a href=./shohinichiran>商品一覧</a>");
                      
                  }    
                  if(a == 0){
                      out.println("ログインできませんでした");
                      out.println("<a href=./loginf.jsp>ログインフォームへ</a>");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet log1</title>");            
            out.println("</head>");
            out.println("<body>");
